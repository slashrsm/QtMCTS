...
# Generated by qmake (2.01a) (Qt 4.6.2) on: sob okt 2 16:32:07 2010
# Project:  QtMCTS.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile QtMCTS.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Isrc -Isrc/config -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = src/ApproachKingPlayer.cpp \
		...
		src/config/log.cpp moc_ApproachKingPlayer.cpp \
		moc_Bishop.cpp \
		moc_ConfigParse.cpp \
		moc_Game.cpp \
		...
		moc_ToCenterPlayer.cpp
OBJECTS       = ApproachKingPlayer.o \
		Bishop.o \
		ConfigParse.o \
		Game.o \
		GoToBorderGame.o \
...
Makefile: QtMCTS.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile QtMCTS.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QtMCTS1.0.0/ && $(COPY_FILE) --parents src/ApproachKingPlayer.h src/Bishop.h src/ConfigParse.h src/environment.h src/Game.h src/GoToBorderGame.h src/GoToCornerDirectGame.h src/GoToCornerGame.h src/KBNKLooserPlayer.h src/King.h src/Knight.h src/MCTSNode.h src/MCTSPlayer.h src/Piece.h src/Player.h src/Position.h src/Queen.h src/RandomPlayer.h src/Rook.h src/TableBase.h src/TableBlackPlayer.h src/TableWhitePlayer.h src/ToCenterPlayer.h src/config/config.h src/config/log.h .tmp/QtMCTS1.0.0/ && $(COPY_FILE) --parents src/ApproachKingPlayer.cpp src/Bishop.cpp src/ConfigParse.cpp src/Game.cpp src/GoToBorderGame.cpp src/GoToCornerDirectGame.cpp src/GoToCornerGame.cpp src/KBNKLooserPlayer.cpp src/King.cpp src/Knight.cpp src/main.cpp src/MCTSNode.cpp src/MCTSPlayer.cpp src/Piece.cpp src/Player.cpp src/Position.cpp src/Queen.cpp src/RandomPlayer.cpp src/Rook.cpp src/TableBase.cpp src/TableBlackPlayer.cpp src/TableWhitePlayer.cpp src/ToCenterPlayer.cpp src/config/config.cpp src/config/log.cpp .tmp/QtMCTS1.0.0/ && (cd `dirname .tmp/QtMCTS1.0.0` && $(TAR) QtMCTS1.0.0.tar QtMCTS1.0.0 && $(COMPRESS) QtMCTS1.0.0.tar) && $(MOVE) `dirname .tmp/QtMCTS1.0.0`/QtMCTS1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QtMCTS1.0.0
...
compiler_moc_header_make_all: moc_ApproachKingPlayer.cpp moc_Bishop.cpp moc_ConfigParse.cpp moc_Game.cpp moc_GoToBorderGame.cpp moc_GoToCornerDirectGame.cpp moc_GoToCornerGame.cpp moc_KBNKLooserPlayer.cpp moc_King.cpp moc_Knight.cpp moc_MCTSNode.cpp moc_MCTSPlayer.cpp moc_Piece.cpp moc_Player.cpp moc_Position.cpp moc_Queen.cpp moc_RandomPlayer.cpp moc_Rook.cpp moc_TableBase.cpp moc_TableBlackPlayer.cpp moc_TableWhitePlayer.cpp moc_ToCenterPlayer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ApproachKingPlayer.cpp moc_Bishop.cpp moc_ConfigParse.cpp moc_Game.cpp moc_GoToBorderGame.cpp moc_GoToCornerDirectGame.cpp moc_GoToCornerGame.cpp moc_KBNKLooserPlayer.cpp moc_King.cpp moc_Knight.cpp moc_MCTSNode.cpp moc_MCTSPlayer.cpp moc_Piece.cpp moc_Player.cpp moc_Position.cpp moc_Queen.cpp moc_RandomPlayer.cpp moc_Rook.cpp moc_TableBase.cpp moc_TableBlackPlayer.cpp moc_TableWhitePlayer.cpp moc_ToCenterPlayer.cpp
moc_ApproachKingPlayer.cpp: src/Player.h \
		src/Position.h \
		src/Piece.h \
		src/ApproachKingPlayer.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/ApproachKingPlayer.h -o moc_ApproachKingPlayer.cpp
...
moc_ConfigParse.cpp: src/config/config.h \
		src/ConfigParse.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/ConfigParse.h -o moc_ConfigParse.cpp
...
moc_ToCenterPlayer.cpp: src/Player.h \
		src/Position.h \
		src/Piece.h \
		src/ToCenterPlayer.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/ToCenterPlayer.h -o moc_ToCenterPlayer.cpp
...
ApproachKingPlayer.o: src/ApproachKingPlayer.cpp src/ApproachKingPlayer.h \
		src/Player.h \
		src/Position.h \
		src/Piece.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ApproachKingPlayer.o src/ApproachKingPlayer.cpp
...
ConfigParse.o: src/ConfigParse.cpp src/ConfigParse.h \
		src/config/config.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ConfigParse.o src/ConfigParse.cpp
...
ToCenterPlayer.o: src/ToCenterPlayer.cpp src/ToCenterPlayer.h \
		src/Player.h \
		src/Position.h \
		src/Piece.h \
		src/King.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ToCenterPlayer.o src/ToCenterPlayer.cpp

config.o: src/config/config.cpp src/config/config.h \
		src/config/log.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o config.o src/config/config.cpp

log.o: src/config/log.cpp src/config/log.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o log.o src/config/log.cpp

moc_ApproachKingPlayer.o: moc_ApproachKingPlayer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ApproachKingPlayer.o moc_ApproachKingPlayer.cpp

moc_Bishop.o: moc_Bishop.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Bishop.o moc_Bishop.cpp

moc_ConfigParse.o: moc_ConfigParse.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ConfigParse.o moc_ConfigParse.cpp
...
moc_ToCenterPlayer.o: moc_ToCenterPlayer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ToCenterPlayer.o moc_ToCenterPlayer.cpp
