 ...
 * Constructors
 */
GoToCornerDirectGame::GoToCornerDirectGame(QSharedPointer<Player> white, QSharedPointer<Player> black, int maxmoves=100, int timelimit=10, QString event="", QString pgn="", bool black_on_turn=false, bool simulation=false) : Game(white, black, maxmoves, timelimit, event, pgn, black_on_turn, simulation) {}

GoToCornerDirectGame::~GoToCornerDirectGame() {}

/*
 * Tests if game ended.
 */
bool GoToCornerDirectGame::game_ended(){ return this->is_in_corner() || this->white_lost_piece() || this->cannot_move(); }

/*
 * Returns winner.
 */
QSharedPointer<Player> GoToCornerDirectGame::winner(){
//	if (this->white->situation->size() < 3)
//		return this->black;
 ...
 */
bool GoToCornerDirectGame::is_in_corner(){
    // Find his Bishop
 ...
 */
bool GoToCornerDirectGame::is_in_corner_area(){
...
// */
//bool GoToCornerDirectGame::white_lost_piece(){ return this->white->situation->size() < 3; }
